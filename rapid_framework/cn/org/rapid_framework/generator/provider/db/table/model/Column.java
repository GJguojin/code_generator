...
public class Column implements java.io.Serializable, Cloneable
{
	...
	{
		this( c.getTable(), c.getSqlType(), c.getSqlTypeName(), c.getSqlName(), c.getSize(), c.getDecimalDigits(), c.isPk(), c.isNullable(), c.isIndexed(), c
						.isUnique(), c.getDefaultValue(), c.getRemarks() );
	}
	...
	/**
	 * 列的别名，等价于：getRemarks().isEmpty() ? getColumnNameFirstLower() : getRemarks() <br />
	 * 示例值: birthDate
	 */
